                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" value="<%= ((BaseClasses.User)session.getAttribute("user")).getFirstName() %>">
                              </div>
                              <label class="col-sm-2 col-sm-2 control-label">Last Name</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" value="<%= ((BaseClasses.User)session.getAttribute("user")).getLastName() %>">
                              </div>
