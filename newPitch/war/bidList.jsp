	...
	<!--main content start-->
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Discover <%=request.getParameter("pitch")%>'s Bidders</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
					<% 
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="content-panel pn">
								<form id="form" action="/bid" method="get">
									...
									-->
									<div class="centered">
										<h6><i class="fa fa-envelope"></i><br/><%=((BaseClasses.User)DB.DBManager.getInstance().getUserByID(bidder)).getEmail()%></h6>
									</div>
