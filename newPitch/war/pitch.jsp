                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="index.jsp#">
                            ...
                            <span class="badge bg-theme"><%=((java.util.ArrayList<Message>)((BaseClasses.User)session.getAttribute("user")).getMessages()).size() %></span>
                        </a>
                        <ul class="dropdown-menu extended inbox">
                            <div class="notify-arrow notify-arrow-green">
                            </div>
                            <li>
                                <p class="green">You have <%=((java.util.ArrayList<Message>)((BaseClasses.User)session.getAttribute("user")).getMessages()).size() %> new messages</p>
                            </li>
                            ...
                            <li>
                                <a href="index.jsp#">
                                    ...
                                    <span class="subject">
                                    <span class="from"><%= msg.getFrom()%></span>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="mypitches.jsp" >
                  ...
                  <div class="col-lg-3 ds">
                    <!--COMPLETED ACTIONS DONUTS CHART-->
                      ...
                      <div class="desc">
                      	...
                      	<div class="details">
                      		<p><muted><%= note.getDate().toGMTString() %></muted><br/>
                      		   <%=note.getFrom() %>: <%=note.getBody() %><br/>
                      		</p>
                      	</div>
                      </div>
                      <%} %>
                    <!-- USERS ONLINE SECTION -->
                      ...
                      <div class="desc">
                      	...
                      	<div class="details">
                      		<p><a href="#"><%=((BaseClasses.User)DB.DBManager.getInstance().getById(member)).getName() %></a><br/>
